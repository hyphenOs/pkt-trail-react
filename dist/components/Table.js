...
const Table = ({
  ...
  const handleScroll = e => {
    ...
    if (isScrollBegin) {
      ...
      if (start < minFrameNo) {
        ...
        setWindowEnd(Math.min(maxFrameNo, minFrameNo + config.packetWindowSize));
      } else {
  ...
  const handleRowClick = (index, packet) => {
    selectedPacketRow.index === index ? setSelectedPacketRow({
      index: null,
      packet: null
    }) : setSelectedPacketRow({
      index,
      packet
    });
  };
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
    onClick: () => setAutoscroll(autoscroll => !autoscroll)
  }, "Autoscroll: ", autoscroll ? "On" : "Off"), /*#__PURE__*/React.createElement("div", {
